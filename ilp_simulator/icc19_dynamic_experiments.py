...
inc_blocking_prob = []
batch_blocking_prob = []
inc_batch_blocking_prob = []
inc_batch_blocking_prob2 = []
inc_batch_blocking_prob3 = []
inc_batch_blocking_prob4 = []
...
for i in range(exec_number):
	...
	inc_batch_blocking_prob.append(numpy.divide(sim.total_inc_batch_blocking, sim.total_requested))
	util.resetParams()
...
for i in range(exec_number):
	...
	inc_batch_blocking_prob2.append(numpy.divide(sim.total_inc_batch_blocking, sim.total_requested))
	util.resetParams()
...
for i in range(exec_number):
	...
	inc_batch_blocking_prob3.append(numpy.divide(sim.total_inc_batch_blocking, sim.total_requested))
	util.resetParams()
...
for i in range(exec_number):
	...
	inc_batch_blocking_prob4.append(numpy.divide(sim.total_inc_batch_blocking, sim.total_requested))
	util.resetParams()
'''
'''
...
total_inc_batch_blocking_prob= [float(sum(col))/len(col) for col in zip(*inc_batch_blocking_prob)]
total_inc_batch_blocking_prob2= [float(sum(col))/len(col) for col in zip(*inc_batch_blocking_prob2)]
total_inc_batch_blocking_prob3= [float(sum(col))/len(col) for col in zip(*inc_batch_blocking_prob3)]
total_inc_batch_blocking_prob4= [float(sum(col))/len(col) for col in zip(*inc_batch_blocking_prob4)]
#total requested
...
#load inc batch
#1
inc_batch_power_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_power)]
inc_batch_lambda_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_lambda_usage)]
inc_batch_migrations_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*batch_ext)]
inc_batch_blocking_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_blocked)]
inc_batch_exec_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_time)]
inc_batch_migration_probability_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_migrations)]
#inc_batch_availability_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*avg_batch_availability)]
inc_batch_redir_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_redir)]

#2
inc_batch_power_ci2 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_power)]
inc_batch_lambda_ci2 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_lambda_usage)]
inc_batch_migrations_ci2 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*batch_ext)]
inc_batch_blocking_ci2 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_blocked)]
inc_batch_exec_ci2 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_time)]
inc_batch_migration_probability_ci2 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_migrations)]
#inc_batch_availability_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*avg_batch_availability)]
inc_batch_redir_ci2 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_redir)]

#3
inc_batch_power_ci3 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_power)]
inc_batch_lambda_ci3 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_lambda_usage)]
inc_batch_migrations_ci3 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*batch_ext)]
inc_batch_blocking_ci3 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_blocked)]
inc_batch_exec_ci3 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_time)]
inc_batch_migration_probability_ci3 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_migrations)]
#inc_batch_availability_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*avg_batch_availability)]
inc_batch_redir_ci3 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_redir)]

#4
inc_batch_power_ci4 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_power)]
inc_batch_lambda_ci4 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_lambda_usage)]
inc_batch_migrations_ci4 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*batch_ext)]
inc_batch_blocking_ci4 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_blocked)]
inc_batch_exec_ci4 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_time)]
inc_batch_migration_probability_ci4 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_migrations)]
#inc_batch_availability_ci = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*avg_batch_availability)]
inc_batch_redir_ci4 = [mean_confidence_interval(col, confidence = 0.95) for col in zip(*total_batch_redir)]
'''
...
#confidence intervals
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/redirected_ci{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#service availability
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/service_availability_probability_ci{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/migrations_probability_ci{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
    filehandle.writelines("%s\n" % p for p in batch_migration_probability_ci)
#blocking probability
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/blocking_prob_ci{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Inc\n\n")
    filehandle.writelines("%s\n" % p for p in inc_blocking_prob_ci)
#power consumption
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/power_ci{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#lambda usage
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/lambda_usage_ci{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#blocking
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/blocking_ci{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#exec time
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/exec_ci{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#migrations
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/migration_ci{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
    filehandle.writelines("%s\n" % p for p in batch_migrations_ci)

#power consumption
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/power_consumption{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#logging of means
#blocking probability
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/avg_blocking_probability{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Inc\n\n")
    filehandle.writelines("%s\n" % p for p in total_inc_blocking_prob)
    filehandle.write("\n")

    filehandle.write("LoadInc Threshold {}\n\n".format(old_th))
    filehandle.writelines("%s\n" % p for p in total_inc_batch_blocking_prob)
    filehandle.write("\n")
    filehandle.write("LoadInc Threshold {}\n\n".format(old_th2))
    filehandle.writelines("%s\n" % p for p in total_inc_batch_blocking_prob2)
    filehandle.write("\n")
    filehandle.write("LoadInc Threshold {}\n\n".format(old_th3))
    filehandle.writelines("%s\n" % p for p in total_inc_batch_blocking_prob3)
    filehandle.write("\n")
    filehandle.write("LoadInc Threshold {}\n\n".format(sim.network_threshold))
    filehandle.writelines("%s\n" % p for p in total_inc_batch_blocking_prob4)
    filehandle.write("\n")

#lambda usage
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/lambda_usage{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#proc usage
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/dus_usage{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#external migrations
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/external_migrations{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#active nodes
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/avg_activated_nodes{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#active lambdas
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/avg_activated_lambdas{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/avg_redirected{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#active switches
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/avg_activated_switches{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#blocked RRHs
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/avg_blocked{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/avg_solution_time{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/avg_cloud_use{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/avg_fog_use{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/amount_external_migrations{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/amount_served_rrhs{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/requested_rrhs{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
'''
#service availability
with open('/home/tinini/Área de Trabalho/nfv_cp/logsISCC/batchRedir/service_availability{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
